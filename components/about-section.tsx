...
import { Code2, Palette, Sparkles, Zap, Terminal } from "lucide-react";
...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 sm:py-32 relative overflow-hidden bg-[#020617]">
        ...
        {/* Header Section - The "Hyped" Version */}
          <div className="flex flex-col items-center text-center mb-24 relative">
            ...
            >
              ...
              <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-transparent flex items-center justify-center border border-primary/50 backdrop-blur-xl shadow-[0_0_20px_rgba(var(--primary),0.3)]">
            ...
            >
              <span className="h-[1px] w-8 bg-gradient-to-r from-transparent to-primary" />
              <span className="text-primary text-xs font-mono uppercase tracking-[0.3em] font-bold">
                Digital Architect
              </span>
              <span className="h-[1px] w-8 bg-gradient-to-l from-transparent to-primary" />
            </motion.div>
    ...
    <div className="relative h-full bg-[#0a0f1d]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 overflow-hidden">
        ...
        <span className="relative inline-block ml-2 text-primary">
          ...
          <motion.svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 100 10" preserveAspectRatio="none">
            <motion.path 
              ...
              transition={{ delay: 1, duration: 0.8 }}
              d="M0 5 Q 25 0, 50 5 T 100 5" stroke="currentColor" strokeWidth="2" fill="none" 
            />
          </motion.svg>
        </span>
        {" "}experiences.
      ...
      <div className="space-y-6 text-slate-400 text-lg leading-relaxed max-w-2xl">
        <p className="relative">
          ...
          <span className="text-white font-medium">Mohamed Adel</span> = {"{"} 
          role: <span className="text-emerald-400">'Front-End Alchemist'</span>,
          mission: <span className="text-emerald-400">'Build for the future'</span>
          {"}"};
        </p>
        
        <p>
          I specialize in bridging the gap between <span className="text-white font-semibold underline decoration-primary/30">design and engineering</span>. 
          My goal is to create interfaces that don't just work, but feel intuitive and alive.
        </p>

        {/* Tech Stack - Floating Pill Style */}
        <div className="pt-8 flex flex-wrap gap-3">
          {["React", "Next.js 15", "Tailwind", "Framer", "TypeScript", "Node.js"].map((tech, i) => (
            <motion.span
              key={tech}
            ...
            >
              <span className="text-primary/50 mr-1">#</span>{tech}
            </motion.span>
          ))}
        </div>
      </div>
  ...
  <div className="lg:col-span-2 grid grid-cols-1 gap-4">
    {highlights.map((item, index) => (
      ...
      >
        ...
        <div className={`p-4 rounded-2xl bg-white/5 border border-white/10 group-hover:scale-110 group-hover:bg-primary/10 transition-all duration-500 ${item.color}`}>
